-- Function: fnsclgetchannelplotdata(integer, integer, date, date)

-- DROP FUNCTION fnsclgetchannelplotdata(integer, integer, date, date);

CREATE OR REPLACE FUNCTION fnsclgetchannelplotdata(
    integer,
    integer,
    date,
    date)
