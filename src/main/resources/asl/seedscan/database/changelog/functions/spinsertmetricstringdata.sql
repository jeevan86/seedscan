-- Function: spinsertmetricstringdata(date, character varying, character varying, character varying, character varying, character varying, text, bytea)

-- DROP FUNCTION spinsertmetricstringdata(date, character varying, character varying, character varying, character varying, character varying, text, bytea);

CREATE OR REPLACE FUNCTION spinsertmetricstringdata(
    date,
    character varying,
    character varying,
    character varying,
