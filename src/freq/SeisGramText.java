...
public class SeisGramText {
	...
	private static final Logger logger = LoggerFactory
			.getLogger(freq.SeisGramText.class);
	...
	// error messages
	String ERROR_MULTIPLE_PHASES_FOUND = "WARNING: multiple P, S or CODA picks found.";

	// Butterworth filter exceptions
	String invalid_low_frequency_corner = "invalid low frequency corner.";
	String invalid_high_frequency_corner = "invalid high frequency corner.";
	String invalid_number_of_poles = "invalid number of poles.";
	String low_corner_greater_than_high_corner = "low frequency corner greater than high frequency corner.";
	// Gaussian filter exceptions
	String invalid_center_frequency = "invalid center frequency.";
	String invalid_alpha_value = "invalid alpha value.";
	...
	public SeisGramText(String locName) {
		...
		if (localeName.equalsIgnoreCase("fr_FR")) {
			...
			// error messages
			ERROR_MULTIPLE_PHASES_FOUND = "ATTENTION: multiple P, S ou CODA pointées trouvée.";

			// Butterworth filter exceptions
			invalid_low_frequency_corner = "invalid low frequency corner.";
			invalid_high_frequency_corner = "invalid high frequency corner.";
			invalid_number_of_poles = "invalid number of poles.";
			low_corner_greater_than_high_corner = "low frequency corner greater than high frequency corner.";
			// Gaussian filter exceptions
			invalid_center_frequency = "invalid center frequency.";
		...
		// Italian, Italy
			...
			// error messages
			ERROR_MULTIPLE_PHASES_FOUND = "ATTENZIONE: multiple P, S or CODA picks non trovati.";
	...
	public Locale toLocale() {
		...
		if (ndx > 0) {
			...
			// System.out.println("1 - language: <" + language + ">  country: <"
			...
			if (ndx > 0) {
				...
				// variant
				variant = locStr;
				// System.out.println("2 - language: <" + language +
				// ">  country: <" + country + ">  variant: <" + variant + ">");
			} else {
				country = locStr;
				// System.out.println("3 - language: <" + language +
				// ">  country: <" + country + ">  variant: <" + variant + ">");
			}
		} else {
			language = locStr;
		}
		// System.out.println("4 - language: <" + language + ">  country: <" +
		// country + ">  variant: <" + variant + ">");
