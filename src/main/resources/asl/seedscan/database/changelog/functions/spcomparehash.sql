-- Function: spcomparehash(date, character varying, character varying, character varying, character varying, character varying, bytea)

-- DROP FUNCTION spcomparehash(date, character varying, character varying, character varying, character varying, character varying, bytea);

CREATE OR REPLACE FUNCTION spcomparehash(
    date,
    character varying,
    character varying,
    character varying,
