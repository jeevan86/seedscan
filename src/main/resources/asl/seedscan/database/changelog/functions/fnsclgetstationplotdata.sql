-- Function: fnsclgetstationplotdata(integer, integer, date, date)

-- DROP FUNCTION fnsclgetstationplotdata(integer, integer, date, date);

CREATE OR REPLACE FUNCTION fnsclgetstationplotdata(
    integer,
    integer,
    date,
    date)
